...
ActiveRecord::Schema.define(version: 20170207035248) do
  ...
  create_table "lawyers", force: :cascade do |t|
    ...
    t.boolean  "be_noticed",             default: true
  end

  add_index "lawyers", ["be_noticed"], name: "index_lawyers_on_be_noticed", using: :btree
