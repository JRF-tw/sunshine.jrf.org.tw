...
describe "觀察者帳號相關", type: :request do
  context "登入" do
    ...
    context "失敗送出" do
      ...
      context "其他情境" do
        context "觀察者A與B 有相同的待驗證email, A點完驗證連結之後 B才點驗證連結" do
          let!(:court_observer_A) { observer_with_unconfirm_email_init("ggyy@gmail.com") }
          let!(:court_observer_B) { observer_with_unconfirm_email_init("ggyy@gmail.com") }
