    ...
    context '手機號碼輸入頁' do
      ...
      context '失敗送出' do
        ...
        context '連續發送 n 次後，使目前已超過簡訊發送限制' do
          ...
          subject! { post '/party/phone', party: { unconfirmed_phone: '0911111113' } }
        ...
        context '號碼格式不符' do
          ...
          context '空白' do
            subject! { post '/party/phone', party: { unconfirmed_phone: '' } }
          ...
          context '過長' do
            subject! { post '/party/phone', party: { unconfirmed_phone: '091111111111' } }
          ...
          context '過短' do
            subject! { post '/party/phone', party: { unconfirmed_phone: '0911' } }
          ...
          context '非09開頭' do
            subject! { post '/party/phone', party: { unconfirmed_phone: '0811111111' } }
          ...
          context '非全數字' do
            subject! { post '/party/phone', party: { unconfirmed_phone: '091111a111' } }
