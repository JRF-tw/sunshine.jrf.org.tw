...
describe Defendant::ChangeEmailContext do
  ...
  describe "perform" do
    ...
    context "email already exist" do
      ...
      let(:params) { { email: defendant2.email, current_password: "12321313213" } }
    ...
    context "update the same email" do
      let(:params) { { email: defendant.email, current_password: "12321313213" } }
    ...
    context "update other's unconfirmed_email" do
      ...
      let(:params) { { email: defendant2.unconfirmed_email, current_password: "12321313213" } }
