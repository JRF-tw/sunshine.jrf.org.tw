class Admin::ProfilesController < Admin::BaseController
  ...
  def profile_params
    params.fetch(:admin_profile, {}).permit(:name, :current, :avatar, :remove_avatar, :gender, :birth_year, :stage, :appointment, :memo, :gender_source, :birth_year_source, :stage_source, :appointment_source, :is_active, :is_hidden)
  end
end
