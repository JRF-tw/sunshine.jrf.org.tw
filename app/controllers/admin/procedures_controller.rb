...
class Admin::ProceduresController < Admin::BaseController
  ...
  def procedure_params
    params.fetch(:admin_procedure, {}).permit(:profile_id, :suit_id, :unit, :title, :procedure_unit, :procedure_content, :procedure_result, :procedure_no, :procedure_date_in_tw, :procedure_date, :suit_no, :source, :source_link, :punish_link, :file, :memo, :is_hidden)
  end
end
