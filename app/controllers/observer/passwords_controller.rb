class Observer::PasswordsController < Devise::PasswordsController
  ...
  def edit
    if current_court_observer && CourtObserver.with_reset_password_token(params[:reset_password_token]) != current_court_observer
      redirect_as_fail(observer_profile_path, "你僅能修改本人的帳號")
    else
