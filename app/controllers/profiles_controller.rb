class ProfilesController < BaseController
  def judges
    @judges = Profile.judges.shown.active.had_avatar.by_punishments.page(params[:page]).per(12)
    set_meta(
      title: "認識法官",
  ...
  def prosecutors
    @prosecutors = Profile.prosecutors.shown.active.had_avatar.by_punishments.page(params[:page]).per(12)
    set_meta(
      title: "認識檢察官",
