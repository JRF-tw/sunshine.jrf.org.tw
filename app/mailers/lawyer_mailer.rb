class LawyerMailer < ApplicationMailer
  ...
  def generate_score_verdicts_link(story)
    new_lawyer_score_verdict_url(verdict_score: { court_id: story.court, year: story.year, word_type: story.word_type, number: story.number, story_type: story.story_type })
  end
end
